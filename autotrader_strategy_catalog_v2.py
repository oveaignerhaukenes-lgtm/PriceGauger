...
FAMILY_MACD_HIST_SPEC_V1 = _spec(
    FAMILY_MACD_HIST_STRATEGY_V1,
    "macd-hist · parameterized",
    "LONG on two consecutive rising closed MACD histogram bars; SHORT on two falling bars, regardless of zero.",
)
...
AUTOTRADER_STRATEGIES_V2 = (
    ...
    PRICE_STOCH_SPEC_V1, FAMILY_MACD_SPEC_V1, FAMILY_MACD_HIST_SPEC_V1, FAMILY_PRICE_MACD_SPEC_V1,
