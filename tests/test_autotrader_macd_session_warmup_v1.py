...
def test_wider_warmup_keeps_closed_bar_gap_guards() -> None:
    ...
    assert 'reason = f"CLOSED_{minutes}M_PRIMED"' in source
    assert "live_macd_intrabar_clock_v1(" not in source
