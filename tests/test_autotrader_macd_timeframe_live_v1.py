...
def test_2m_and_15m_shadow_keys_are_the_same_keys_exposed_live() -> None:
    assert LIVE_MACD_CONTROL_TIMEFRAMES_V1 == (2, 15)
...
def test_catalog_exposes_both_as_symmetric_long_short_live_choices() -> None:
