...
def test_macd_strategy_entry_direction_capabilities_are_explicit():
    ...
    assert MTF_LONG_SHORT_FLIP_SPEC_V2.can_long is True
    assert MTF_LONG_SHORT_FLIP_SPEC_V2.can_short is True
...
def test_templates_expose_only_reviewed_live_capabilities():
    ...
    assert MTF_LONG_SHORT_FLIP_STRATEGY_V2 in live_keys
