...
def test_live_readiness_requires_explicit_arm_and_live_endpoint(tmp_path):
    ...
    assert live_readiness_v3(e,broker_is_live=True,exact_inventory=.01,db_path=db).ready
