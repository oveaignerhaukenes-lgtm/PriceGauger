...
def test_incomplete_forecast_is_not_drawn_as_complete_layer():
    ...
    incomplete = ForecastSnapshot(
        ...
        direction="LONG_BIAS", direction_score=0.7, confidence=0.65, expected_move_low_pct=None, expected_move_high_pct=None,
        horizon_hours=4.0, time_scale="HOURS", decision_snapshot_id="decision:bad", information_snapshot_id="information:bad",
        market_snapshot_id="market:bad", status="DEGRADED", missing_inputs=("expected_move_interval",), status_reason="test",
    )
