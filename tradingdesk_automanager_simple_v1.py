...
def render_tradingdesk_automanager_simple_v1(
    ...
    # widget state can otherwise become stale after backend adoption/restart and show
    # Manage position OFF while the dispatcher is actively managing the product.
